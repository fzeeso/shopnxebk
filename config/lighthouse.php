...
return [
    ...
    */
    ...
    'security' => [
        'max_query_complexity' => (int) env('GRAPHQL_MAX_COMPLEXITY', 500),
        'max_query_depth' => (int) env('GRAPHQL_MAX_DEPTH', 12),
        'disable_introspection' => env('APP_ENV', 'production') === 'production' && ! (bool) env('GRAPHQL_INTROSPECTION_ENABLED', false)
    ...
    */
    ...
    'debug' => (int) env('LIGHTHOUSE_DEBUG', 0),
