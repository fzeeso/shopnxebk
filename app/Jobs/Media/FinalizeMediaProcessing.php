...
final class FinalizeMediaProcessing implements ShouldQueue
{
    ...
    {
        $processor->markReady($this->media());
    }

    /** @return list<string> */
    public function tags(): array
    {
        return ['media:'.$this->mediaId, 'store:'.$this->storeId, 'media-step:finalize'];
    }
