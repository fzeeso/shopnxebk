...
#[Fillable(['store_id', 'product_modifier_assignment_id', 'modifier_id', 'modifier_value_id', 'currency_code', 'adjustment_type', 'amount', 'channel_id', 'customer_group_id', 'starts_at', 'ends_at', 'is_active'])]
final class ProductModifierValuePriceOverride extends Model
{
    use StoreScoped;
