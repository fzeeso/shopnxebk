...
final class CreateMerchantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'store' => ['required', 'array:name,slug,legal_name,description,email,phone,primary_domain,industry,business_type,currency_code,language_code,timezone,country_code'],
            'store.name' => ['required', 'string', 'max:120'],
            'store.slug' => ['required', 'alpha_dash:ascii', 'min:3', 'max:80', 'unique:stores,slug'],
            ...
            'store.primary_domain' => ['sometimes', 'nullable', 'string', 'max:253', 'unique:stores,primary_domain'],
