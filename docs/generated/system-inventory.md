...
| `POST` | `/api/v1/store/media/ai/generate` | `api.v1.store.media.ai.generate` | api, auth:sanctum, Modules\Authentication\Http\Middleware\EnsureUserScope:store, store, store.member, throttle:6,1 |
...
| `POST` | `/api/v1/store/media/{media}/ai` | `api.v1.store.media.ai.run` | api, auth:sanctum, Modules\Authentication\Http\Middleware\EnsureUserScope:store, store, store.member, throttle:10,1 |
